...
/**
 * Created by JsonQiu on 2017/12/13.
 */
public class Main3Activity extends AppCompatActivity implements MyItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            map.put("ItemImage", R.mipmap.app_log);
            listItem.add(map);
